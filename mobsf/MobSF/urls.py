...
urlpatterns = [
    ...
    re_path(r'^api/v1/apk_editor/logs$',
            apk_editor_api.api_logs),
    # Static Suppression
...
if settings.API_ONLY == '0':
    urlpatterns.extend([
        ...
        re_path(fr'^manifest_view/{checksum_regex}/$',
                manifest_view.run,
                name='manifest_view'),
        re_path(r'^apk_editor/$',
                apk_editor_web.editor,
                name='apk_editor_home'),
        re_path(r'^apk_editor/upload/$',
                apk_editor_web.upload,
                name='apk_editor_upload'),
        ...
        re_path(r'^apk_editor/logs/$',
                apk_editor_web.logs,
                name='apk_editor_logs'),
        # IOS
